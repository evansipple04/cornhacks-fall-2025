...
export default function ProjectCard({
  ...
  return (
    <>
      <div 
        className="w-[350px] h-[500px] rounded-[2rem] overflow-hidden bg-white border-2 border-gray-200 hover:scale-[1.02] flex flex-col cursor-pointer transition-all duration-300"
        style={{
      ...
      >
        ...
        <div className="px-6 py-4 flex flex-col h-[334px] items-center text-center">
